...
class Navigator @Inject constructor() { // TODO: FragmentActivity removed as we can't inject it at the moment

//    fun startPostDetailFragment() {
//        // Create fragment and give it an argument specifying the article it should show
//        val postDetailFragment = UserDetailFragment()
//        val transaction = context.supportFragmentManager.beginTransaction().apply {
